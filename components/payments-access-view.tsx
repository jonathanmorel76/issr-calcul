...
export default function PaymentsAccessView({userId}:{userId:string}){
 ...
 return <main className="dashboard-main reports-page payments-page">
  <section className="dashboard-panel report-panel">
   ...
   <p>Le calcul de vos droits reste disponible gratuitement. Le rapprochement avec vos bulletins de paie, la détection des écarts et la préparation d’une régularisation prennent le relais lorsque vous souhaitez contrôler les montants réellement reçus.</p>
  </section>
