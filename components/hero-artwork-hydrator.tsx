...
const ART:Record<string,string>={
 ...
 bilans:'<svg viewBox="0 0 360 150" preserveAspectRatio="xMaxYMid slice"><g fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M210 111V52h74v59M225 94V78M244 94V65M263 94V56M218 101h58"/><path d="M303 99l13-18 12 8 22-31M341 58h9v9"/></g></svg>',
 documents:'<svg viewBox="0 0 360 150" preserveAspectRatio="xMaxYMid slice"><g fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M222 35h54l18 18v60h-72zM276 35v20h18M237 72h42M237 85h42M237 98h27"/><path d="M311 55h28v57h-28M319 70h12M319 82h12M319 94h12"/></g></svg>'
}
...
function kindFor(title:string){
 ...
 if(value.includes('bilan'))return 'bilans'
