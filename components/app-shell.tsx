...
export default function AppShell({userId,initialEntries,initialMissions,initialEstablishments,initialDefaultOrigin,rateSchedules}:Props){
 ...
 if(view==='indemnities')return <div className="product-shell"><header className="product-hero"><div><span className="product-kicker">Mon Remplacement</span><h1>Mes indemnités</h1><p>Contrôlez les journées générées par vos missions, corrigez un trajet si nécessaire et exportez vos justificatifs.</p></div></header>{nav}<main className="dashboard-main indemnities-page"><section className="journey-strip"><span>1 · Établissements</span><b>→</b><span>2 · Missions</span><b>→</b><span className="active">3 · Indemnités</span><b>→</b><span>4 · Bilans</span><b>→</b><span>5 · Documents</span></section><div className="indemnities-embedded"><IssrApp userId={userId}/></div></main></div>
