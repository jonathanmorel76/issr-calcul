...
export default function BilansAccessView({userId}:{userId:string}){
 ...
 return <main className="dashboard-main reports-page">
  <section className="dashboard-panel report-panel"><div className="report-head"><div><span className="eyebrow">Mes bilans</span><h2>Le suivi courant reste gratuit</h2></div></div><p>Le tableau de bord et le suivi du mois en cours restent disponibles sans abonnement. La vue Bilans permet ensuite de consolider l’année scolaire, de comparer les périodes et de produire des exports.</p></section>
