...
export default function BilansAccessView({userId}:{userId:string}){
 ...
 return <main className="dashboard-main reports-page">
  <section className="dashboard-panel report-panel"><div className="report-head"><div><span className="eyebrow">Mes bilans</span><h2>Le suivi courant reste gratuit</h2></div><span className="tag">Premium</span></div><p>Le tableau de bord et le suivi du mois en cours restent disponibles sans abonnement. La vue Bilans devient Premium lorsqu’elle consolide l’année scolaire, compare les périodes et produit des exports.</p></section>
  <PremiumFeatureJourney
   eyebrow="Bilans Premium"
   title="Passez du suivi mensuel à une vision annuelle"
   description="Premium regroupe toute votre année scolaire pour vous aider à comprendre votre activité et conserver une synthèse exploitable."
   steps={[
