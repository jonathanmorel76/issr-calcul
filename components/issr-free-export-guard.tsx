    ...
    const sync=()=>{
      ...
      if(isFree){
        if(!note){
          ...
          note.innerHTML='<span class="premium-badge">PREMIUM</span><span><strong>Exporter mes journées</strong><small>Excel et PDF disponibles avec l’abonnement.</small></span>'
