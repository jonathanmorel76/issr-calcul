...
export default function PayrollAttentionWidget({entries,payments,payslips}:{entries:Entry[];payments:Payment[];payslips:Payslip[]}){
 ...
 return createPortal(<section className={`payroll-top-feature payroll-top-feature-compact ${premium?'premium-active':'free-preview'}`} aria-label="Top fonctionnalité : Paie">
  <div className="payroll-top-ribbon"><span aria-hidden="true">★</span> Top fonctionnalité</div>
  <div className="payroll-top-head">
   <div><span className="eyebrow">Paie Premium</span><h2>Vérifiez que vos ISSR ont vraiment été payées</h2><p>Une vue dédiée rassemble vos droits, vos bulletins, les écarts détectés et les régularisations.</p></div>
