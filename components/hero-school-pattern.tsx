type HeroKind='dashboard'|'establishments'|'missions'|'indemnities'|'bilans'|'documents'|'versements'
 ...
 return <div className={`hero-school-pattern hero-school-pattern-${kind}`} aria-hidden="true">
  <svg viewBox="0 0 360 150" preserveAspectRatio="xMaxYMid slice">
   <g fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
    ...
    {kind==='versements'&&<><circle cx="238" cy="75" r="31"/><path d="M249 59c-4-4-8-5-13-5-10 0-17 8-17 21s7 21 17 21c5 0 10-2 13-6M216 70h27M216 80h24"/><path d="M286 48h54v58h-54zM298 63h30M298 75h30M298 87h18M275 106l13-13"/></>}
