...
export default function DocumentsAccessView({userId}:{userId:string}){
 ...
 return <>
  ...
  {!premium&&<main className="dashboard-main documents-page" style={{paddingTop:0}}><PremiumFeatureJourney
   ...
   title="Au-delà des 5 documents en accès libre"
   description="L’accès libre vous permet de conserver jusqu’à 5 pièces essentielles. Vous pouvez ensuite transformer la bibliothèque en véritable archive de suivi de remplacement."
   steps={[
