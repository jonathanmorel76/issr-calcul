...
const ITEMS:QuickItem[]=[
 {key:'establishments',label:'Mes établissements',short:'Écoles',description:'Gérer mes établissements',icon:NAV_ICONS.establishments,view:'establishments'},
 {key:'missions',label:'Mes missions',short:'Missions',description:'Planifier un remplacement',icon:NAV_ICONS.missions,view:'missions'},
 {key:'indemnities',label:'Mes indemnités',short:'ISSR',description:'Contrôler mes indemnités',icon:NAV_ICONS.indemnities,view:'indemnities'},
 {key:'payroll',label:'Paie',short:'Paie',description:'Comparer droits et versements',icon:NAV_ICONS.payroll,href:'/dashboard/paie',top:true},
 {key:'reports',label:'Mes bilans',short:'Bilans',description:'Consulter mes bilans',icon:NAV_ICONS.reports,href:'/dashboard/bilans'},
 {key:'documents',label:'Mes documents',short:'Docs',description:'Retrouver mes documents',icon:NAV_ICONS.documents,href:'/dashboard/documents'},
]
